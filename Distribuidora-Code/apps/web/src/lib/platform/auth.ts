...
export function logout(): void {
  ...
  // NOTA: adaptado — el original (apps/superadmin) redirigía a '/login'; acá
  // usamos '/platform-login' porque '/login' quedó reservado para el
  // distribuidor en la app unificada.
