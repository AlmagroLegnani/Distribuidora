  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Link href="/admin/orders" className="card p-5 hover:shadow-md transition-shadow flex items-center gap-4">
        ...
        <Link href="/admin/products" className="card p-5 hover:shadow-md transition-shadow flex items-center gap-4">
        ...
        <Link href="/admin/clients" className="card p-5 hover:shadow-md transition-shadow flex items-center gap-4">
