...
import { getUnreadNotifications, markNotificationsRead, StockAlert } from '@/lib/admin/api';

/**
 * Se monta una sola vez en el layout del panel (apps/web/src/app/admin/layout.tsx),
