...
async function main(): Promise<void> {
  ...
  const clientsData = [
    { rut: '76543210-1', name: 'Supermercado El Sol', email: 'compras@elsol.cl', phone: '+56922334455' },
    { rut: '12345678-9', name: 'Minimarket Don Pepe', email: 'donpepe@email.cl', phone: '+56933445566' },
    { rut: '98765432-1', name: 'Almacén La Esquina', email: null, phone: '+56911223344' },
  ];
